    ...
    return (
        ...
        <div style={{paddingLeft: '80px'}}>
            <h1 style={{fontFamily: "Heebo, sans-serif", color: '#EBEBEB'}}>Further Reading</h1>
                ...
                <CardContent>
                    <h4 style={{fontFamily: "Heebo, sans-serif", fontStyle: 'italic', color: '#EBEBEB'}}>What is Concurrency?</h4>
                ...
                <Card style={{backgroundColor: '#303030'}}>
                <CardContent>
                    <h4 style={{fontFamily: "Heebo, sans-serif", fontStyle: 'italic', color: '#EBEBEB'}}>Setting Up Concurrent Mode</h4>
                    <section style={{fontFamily: "Heebo, sans-serif"}}>
                ...
                <Card style={{backgroundColor: '#303030'}}>
                <CardContent>
                    <h4 style={{fontFamily: "Heebo, sans-serif", fontStyle: 'italic', color: '#EBEBEB'}}>More on Concurrent Mode</h4>
                    <section style={{fontFamily: "Heebo, sans-serif"}}>
                        <p style={{color: '#EBEBEB'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga repellendus vel sunt magni. Nulla natus dolorum totam unde enim. Perspiciatis facilis et veritatis porro consectetur? Ipsa id eos odit facilis</p>
                ...
                <Card style={{backgroundColor: '#303030'}}>
                <CardContent>
                    <h4 style={{fontFamily: "Heebo, sans-serif", fontStyle: 'italic', color: '#EBEBEB'}}>What Can You Do with Concurrent Mode?</h4>
                    <section style={{fontFamily: "Heebo, sans-serif"}}>
                        <p style={{color: '#EBEBEB'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga repellendus vel sunt magni. Nulla natus dolorum totam unde enim. Perspiciatis facilis et veritatis porro consectetur? Ipsa id eos odit facilis</p>
